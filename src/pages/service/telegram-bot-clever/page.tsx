...
export default function TelegramBotCleverPage() {
  return (
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <i className="ri-arrow-right-s-line"></i>
            <span className="text-gray-900">Чат-бот под ключ (clever.app)</span>
          </div>

          {/* Header */}
          <div className="mb-12">
            <div className="inline-flex items-center gap-2 bg-sky-50 text-sky-600 px-4 py-2 rounded-full text-sm font-semibold mb-4">
              <i className="ri-telegram-line"></i>
              Чат-боты для Telegram
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">
              Чат-бот для Telegram под ключ (clever.app)
            </h1>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    Каждый чат-бот в Telegram имеет ежемесячную плату за его работу — её собирает Telegram и платформа, не наша команда. Ежемесячная подписка стоит <strong>1.100₽</strong>.
                  </p>
                </div>
              </div>
            </div>
